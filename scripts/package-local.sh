...
if command -v deno >/dev/null 2>&1; then cp "$(command -v deno)" "$TARGET/deno"; chmod +x "$TARGET/deno"; fi
...
2. Coloque yt-dlp e deno nesta mesma pasta ou instale-os no PATH; FFmpeg é recomendado.
3. Execute ./musay.
